...
*/
	...
	function shortcode_simplex_load_plugin_textdomain() {
  	  load_plugin_textdomain( 'shortcode-simplex', FALSE, basename( dirname( __FILE__ ) ) . '/languages/' );
	}
	...
	add_action( 'plugins_loaded', 'shortcode_simplex_load_plugin_textdomain' );	
